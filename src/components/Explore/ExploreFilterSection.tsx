...
const ExploreFilterSection = ({
  ...
  const handleSizeChange = (size: string) => {
    ...
    setSelectedSize(size); // Update selected size in parent component
    console.log(size, "should filter the images");
  };

  return (
    <div className="flex flex-wrap 2xl:gap-20 xl:gap-10 lg:gap-7 gap-4 my-10">
      <Button
        ...
        {/* <div className="flex gap-2 item-center justify-center">
          <div className="bg-[#E1E1E1] w-12">
            <P
              ...
              className="bg-[#102030] m-3 text-center"
            >
              S
            </P>
          </div>
          <div className="bg-[#E1E1E1] w-12">
            <P
              ...
              className="bg-[#102030] m-2 py-1 text-center"
            >
              M
            </P>
          </div>
          ...
          <div className="bg-[#E1E1E1] w-12">
            <P
              ...
              className="bg-[#102030] m-1 py-2 text-center"
            >
              L
            </P>
          </div>
          ...
          <div className="w-12">
            <P
              ...
              className="bg-[#102030] p-3 text-center"
            >
              L
            </P>
          </div>
