...
const ArtworkVisualizer = ({ artwork, isLoading, error }) => {
  ...
  const roomBackgroundImage = customImage || (currentRoom.images && currentRoom.images[selectedRoomImageIndex % currentRoom.images.length]);
  ...
  const visualizerHeight = isFullscreen ? "h-screen" : isMobile ? "h-64" : isTablet ? "h-96" : "h-[500px]";
