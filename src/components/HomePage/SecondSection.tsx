    ...
    <>
      <div className="container mx-auto md:px-6 px-3">
        <div className="flex flex-col sm:flex-row justify-between mt-10">
          <div className="w-full relative sm:mr-4">
            <img src={card1} alt="" className="w-full" />
            <div className="absolute xl:top-24 lg:top-8 md:top-8 top-4 lg:left-14 left-5 xl:w-[40%] lg:w-[50%] w-full text-white">
          ...
          <div className="w-full relative sm:ml-4 mt-6 sm:mt-0">
