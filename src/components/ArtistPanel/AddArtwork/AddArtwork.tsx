                  ...
                  <div className="mt-4">
                    <label className="text-[#203F58] sm:text-base font-semibold">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Field
                          as="select"
                          name="artistFeesCurrency"
                          className="bg-[#F9F9FC] mt-1 border border-gray-300 outline-none text-gray-900 text-sm rounded-lg p-1 sm:p-2.5"
                          // onChange={(e) => {
                          //   // Sync the selected currency with the form state
                          //   setFieldValue("currency", e.target.value);
                          //   setFieldValue("baseFeesCurrency", e.target.value); // Sync this to baseFeesCurrency as well
                          // }}
                          // value={values.baseFeesCurrency}
                        >
